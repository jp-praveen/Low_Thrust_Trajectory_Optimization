START_DIR = C:\Praveen\Matlab_2017\graduate\Assignment_7

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2017a
MAKEFILE = fastode45_MEE_mex.mk

include fastode45_MEE_mex.mki
...
SRC_FILES =  \
	...
	eps.c \
	mpower.c \
	_coder_fastode45_MEE_info.c \
	_coder_fastode45_MEE_api.c \
	_coder_fastode45_MEE_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = fastode45_MEE_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\fastode45_MEE"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\fastode45_MEE/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
